...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--load_size_z', type=int, default=10, help='scale images to this size on z axis')
        parser.add_argument('--crop_size', type=int, default=256, help='then crop to this size')
        parser.add_argument('--crop_size_z', type=int, default=10, help='then crop to this size on z axis')
